...
MioRealtime::emitEvent('orders:42', 'order.created', $minted->token, ['orderId' => 123]);`}
          ...
          <TabsContent value="embed" className="mt-0 space-y-4">
            <Section
              ...
              language="markup"
              code={`<script src="https://cdn.jsdelivr.net/gh/DalesJuvis/realtime-platform@v0.1.3/sdk-wordpress/assets/js/mio-embed.min.js"
  data-ws-url="${wsUrl}"
  data-tenant-id="${tid}"
  data-token="…"
...
></script>`}
            ...
            <Section
              ...
              language="markup"
              code={`<script src="https://cdn.jsdelivr.net/gh/DalesJuvis/realtime-platform@v0.1.3/sdk-wordpress/assets/js/mio-protocol.min.js"></script>
<script src="https://cdn.jsdelivr.net/gh/DalesJuvis/realtime-platform@v0.1.3/sdk-wordpress/assets/js/mio-client.min.js"></script>
<script>
