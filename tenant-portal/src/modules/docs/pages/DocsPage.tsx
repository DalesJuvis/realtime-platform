  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="getting-started" className="flex flex-col gap-6 lg:flex-row">
        <TabsList className="scrollbar-thin h-auto w-full shrink-0 flex-row flex-wrap justify-start gap-1 bg-transparent p-0 lg:sticky lg:top-0 lg:max-h-[calc(100svh-4rem)] lg:w-56 lg:flex-col lg:items-stretch lg:overflow-y-auto lg:py-4">
