...
```html
<script src="https://cdn.jsdelivr.net/gh/DalesJuvis/realtime-platform@v0.1.2/sdk-wordpress/assets/js/mio-embed.min.js"
...
```html
<script src="https://cdn.jsdelivr.net/gh/DalesJuvis/realtime-platform@v0.1.2/sdk-wordpress/assets/js/mio-protocol.min.js"></script>
