...
(function (root, factory) {
  ...
  MioRealtimeClient.isNotificationSupported = function () {
    return typeof window !== 'undefined' && typeof Notification !== 'undefined';
  };

  /** Must be called from a user gesture (a click) in most browsers. */
  MioRealtimeClient.requestNotificationPermission = function () {
    if (!MioRealtimeClient.isNotificationSupported()) return Promise.resolve('denied');
